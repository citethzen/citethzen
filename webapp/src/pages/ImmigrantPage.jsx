    ...
    return (
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>Your current account does not have any Sai. SAI is a cryptocurrency that is pegged to USD, protecting your
            contribution from volatility prior to government acceptance. Contributions can only be made in Sai.</p>
        </div>
